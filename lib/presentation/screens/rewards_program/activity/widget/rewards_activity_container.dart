...
class RewardsActivityContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (rewardsActivityAndOffersBloc.state.isSuccess) {
      return SizedBox(
                ...
                children: [
                  Text(
                    rewardsActivityAndOffersBloc
                        .rewardCouponsActivityModel!.data[index].achievement,
                  ...
                  Text(
                    rewardsActivityAndOffersBloc
                        .rewardCouponsActivityModel!.data[index].description,
                      ...
                      for (int i = 0;
                          i <
                              rewardsActivityAndOffersBloc
                                  ...
                                  .segments;
                          i++) ...[
                        const RewardsProgressContainer(active: true),
                      ]
                    ],
                  )
                ],

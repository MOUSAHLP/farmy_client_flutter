...
class AboutProductAndAmountSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (context.read<ProductdetailsBloc>().is_mounted &&
        context
            .read<BasketBloc>()
            .mutableProducts
            .any((element) => element.id == productDetails.id)) {
      context.read<ProductdetailsBloc>().is_mounted = false;

      context.read<ProductdetailsBloc>().quntity = context
          .read<BasketBloc>()
          .mutableProducts
          .firstWhere((element) => element.id == productDetails.id)
          .quantity!;
    }
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  productDetails.sellerName != null
                                      ? Text(
            ...
            Row(
              ...
              children: [
                CustomCountWidget(
                  ...
                  myIcon: Icons.add,
                  onTap: () {
                    // if (context.read<ProductdetailsBloc>().quntity < quantity) {
                    context.read<ProductdetailsBloc>().add(
                          AddQuntityToOrder(
                            context.read<ProductdetailsBloc>().quntity,
                          ),
                        );
                    // }
                  },
                ...
                InnerShadow(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                        context.read<ProductdetailsBloc>().quntity.toString(),
                ...
                CustomCountWidget(
                  ...
                  myIcon: Icons.remove,
                  onTap: () {
                    if (context.read<ProductdetailsBloc>().quntity >= 0) {
                      context.read<ProductdetailsBloc>().add(

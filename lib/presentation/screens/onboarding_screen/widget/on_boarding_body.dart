...
class OnBoardingBody extends StatelessWidget {
  const OnBoardingBody({super.key,required this.image,required this.imageSlide,required this.text,required this.index});
  final String image;
        ...
        children: [
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  Image.asset(image,fit: BoxFit.fill, width: 1.sw,),
                ],
              ),
            ),
          ),
          Positioned(
            ...
            child: SizedBox(
                width: 1.sw,
                height: 1.sh ,
                child:Image.asset(imageSlide,  width: 1.sw,
                  height: 1.sh ,
                  fit: BoxFit.fill,)
            ),
          ),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: i == index ? ColorManager.yellow : ColorManager.grayForSearch,
                              ),
                            ),
                          ),
                      ],
